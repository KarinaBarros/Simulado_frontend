          ...
          <div className='container'>
            {formVisible && (
              <form onSubmit={handleSubmit} className='form_home'>
                ...
                <textarea  rows={20} className='input_home' type="text" value={ortografia} onChange={(e) => setOrtografia(e.target.value)} maxLength={1000} required />
